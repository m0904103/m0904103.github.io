...
print("Fetching data for new space stocks...")
for sym, name in new_symbols.items():
    ...
    try:
        ...
        tactic = "「太空狂潮」：動能爆發，緊抱不放。" if is_regular else "「破位出局」：結構破壞！生命線之下不買弱勢股。觀望不動是高階決策。"
        ...
        new_stock = {
            ...
            "plan": {
                "entry": latest_close,
                "sl": ma60,
                "tp": round(latest_close * 1.3, 2) # 30% TP for space stocks
            }
        }
...
print("Finished adding space stocks!")
