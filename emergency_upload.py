...
files_to_upload = [
    (r"c:\Users\manpo\OneDrive\桌面\m0904103_github_io\app.py", "app.py"),
    (r"c:\Users\manpo\OneDrive\桌面\m0904103_github_io\requirements.txt", "requirements.txt")
]
...
for local_path, repo_path in files_to_upload:
    ...
    payload = {
        "message": f"Emergency fix for root deployment: {repo_path}",
        "content": content,
        "branch": "main",
        "sha": sha
    }
